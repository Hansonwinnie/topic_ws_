...
public:
    ...
    void setupUi(QMainWindow *DatabaseViewer)
    {
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 307, 380));
        ...
        gridLayout->addWidget(label_priorA, 12, 1, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 306, 380));
        ...
        gridLayout_2->addWidget(label_priorB, 12, 1, 1, 1);
        ...
        page_4->setGeometry(QRect(0, 0, 518, 951));
